...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __nccwpck_require__(231);
	}
...
const cssKeywords = __nccwpck_require__(627);
...
const conversions = __nccwpck_require__(574);
const route = __nccwpck_require__(866);
...
const { dirname, resolve } = __nccwpck_require__(928);
...
var fs = __nccwpck_require__(896),
  join = (__nccwpck_require__(928).join),
  resolve = (__nccwpck_require__(928).resolve),
  dirname = (__nccwpck_require__(928).dirname),
  defaultOptions = {
...
const stripAnsi = __nccwpck_require__(172);
const isFullwidthCodePoint = __nccwpck_require__(277);
const emojiRegex = __nccwpck_require__(434);
...
const ansiRegex = __nccwpck_require__(339);
...
const stringWidth = __nccwpck_require__(54);
const stripAnsi = __nccwpck_require__(172);
const ansiStyles = __nccwpck_require__(606);
...
const {Gludoc, Environment} = __nccwpck_require__(492)
const fs = __nccwpck_require__(896);
const yargs = __nccwpck_require__(39);
...
const {Environment, Configuration} = __nccwpck_require__(276)
const Logger = __nccwpck_require__(923)
const Parser = __nccwpck_require__(764)
const Printer = __nccwpck_require__(859)
const Reader = __nccwpck_require__(488)
...
const {Configuration, Environment} = __nccwpck_require__(276)
...
class Logger {
  ...
  constructor(core) {
    ...
    if(core.config.env === Environment.EXTENSION) {
      const vscode = __nccwpck_require__(629);
...
const patterns = __nccwpck_require__(960);
const Logger = __nccwpck_require__(923);
...
const stringWidth = __nccwpck_require__(54);
const stripAnsi = __nccwpck_require__(172);
const wrap = __nccwpck_require__(878);
function ui(opts) {
    return cliui(opts, {
        stringWidth,
        stripAnsi,
...
const parser = new YargsParser({
    ...
    require: (path) => {
        if (true) {
            return __nccwpck_require__(421)(path);
        }
        else {}
    }
});
...
const {Yargs, processArgv} = __nccwpck_require__(838);
...
function Argv(processArgs, cwd) {
  const argv = Yargs(processArgs, cwd, __nccwpck_require__(500));
  singletonify(argv);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(__nccwpck_require__.s = 552);
