...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __nccwpck_require__(234);
	}
...
const cssKeywords = __nccwpck_require__(392);
...
const conversions = __nccwpck_require__(84);
const route = __nccwpck_require__(959);
...
const stripAnsi = __nccwpck_require__(331);
const isFullwidthCodePoint = __nccwpck_require__(16);
const emojiRegex = __nccwpck_require__(847);
...
const ansiRegex = __nccwpck_require__(524);
...
const stringWidth = __nccwpck_require__(77);
const stripAnsi = __nccwpck_require__(331);
const ansiStyles = __nccwpck_require__(743);
...
const {Gludoc, Environment} = __nccwpck_require__(111)
const fs = __nccwpck_require__(896);
const yargs = __nccwpck_require__(900);
...
const {Environment, Configuration} = __nccwpck_require__(673)
const Logger = __nccwpck_require__(240)
const Parser = __nccwpck_require__(547)
const Printer = __nccwpck_require__(174)
const Reader = __nccwpck_require__(891)
...
const {Configuration, Environment} = __nccwpck_require__(673)
...
class Logger {
  ...
  constructor(core) {
    ...
    if(core.config.env === Environment.EXTENSION) {
      const vscode = __nccwpck_require__(802);
...
const patterns = __nccwpck_require__(991);
const Logger = __nccwpck_require__(240);
...
const stringWidth = __nccwpck_require__(77);
const stripAnsi = __nccwpck_require__(331);
const wrap = __nccwpck_require__(575);
function ui(opts) {
    return cliui(opts, {
        stringWidth,
        stripAnsi,
...
const {Yargs, processArgv} = __nccwpck_require__(721);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(__nccwpck_require__.s = 659);
